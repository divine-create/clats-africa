...
export const T: Record<Language, Record<string, string>> = {
  en: {
    ...
    fiveMinsLeft: "You have 5 minutes left.",
    kobeSays: "Kobe says",
    askKobe: "Ask Kobe",
    ...
    language: "Language",
    back: "Back",
    parentAuthTitle: "Parent or Guardian Dashboard",
    parentAuthSubtitle: "Manage schedules, view progress, and access learning pathways.",
    createChildProfile: "Create Child Profile",
    enterParentMode: "Parental Controls",
    howManyMinutes: "Minutes per learning block",
    completeQuizToFinish: "Solve the mini-quiz below to finish this lesson!",
    welcomeParent: "Good evening",
    trackJourney: "Track your child's learning tech journey.",
    weeklyLearningTime: "Weekly Learning Time (Mins)",
    ...
    aiLearningInsights: "🤖 Deep AI Insights",
    ...
    testingBanner: "🎉 Thanks for helping test CLATS!",
    testingShare: "Share Feedback",
    testingDesc: "Your feedback helps us build tomorrow's tech platform.",
    weeklyAverage: "Weekly Average",
    remaining: "Remaining",
    usedToday: "Used Today",
    dailyLimit: "Daily Limit",
    xpMilestones: "Massive XP Milestones",
    ...
    viewCommunity: "View Parent Community",
    improveClats: "Your feedback helps us shape a better learning experience.",
    ...
    activeProfiles: "Active Child Profiles",
    addProfile: "Add Child Profile",
    todayStudy: "Today's Study",
    completed: "Completed",
    latestAssessment: "Latest Assessment",
    automaticAnalysis: "Automatic intelligence analysis for",
    recentAssessments: "Recent Assessments",
    passed: "PASSED",
    needsReview: "NEEDS REVIEW",
    correctCount: "Correct",
    viewCommunitySpace: "View community space",
    noKidsYet: "No child profiles added yet. Create one to get started!"
  }
};
